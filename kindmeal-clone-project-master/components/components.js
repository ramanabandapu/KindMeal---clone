      ...
      <table>
        <tr id="boxhtr">
          ...
          <td>
            <table>
              <tr>
                <td><a class="boxhtd5" href="log_in.html"> Log in</a></td>
                <td>
                  <a href="facebook.html"
                    ><button id="ntnh1">Facebook</button></a
                  >
                </td>
                <td>
                  <a href="https://myaccount.google.com/"
                    ><button id="ntnh2">Email</button></a
                  >
                </td>
                <td><a class="boxhtd6" href="sign_up.html">Sign Up</a></td>
              </tr>
            </table>
          </td>
        </tr>
...
function boxn() {
     ...
     <div id="boxn">
      <table>
        <tr>
          <td class="boxntext">
            <a class="boxnLinks" href="index.html">Home</a>
          </td>
          <td class="boxntext">
            <a class="boxnLinks" href="MealDeals.html">Meal Deals</a>
          </td>
          <td class="boxntext">KindMoments</td>
          <td class="boxntext">Hot Picks</td>
          <td class="boxntext">
            <a class="boxnLinks" href="Recipes.html">Recipes</a>
          </td>
          <td class="boxntext">Directory</td>
          <td class="boxntext">
            <a class="boxnLinks" href="articles.html">Articles</a>
          </td>
          <td id="boxnclo" class="boxntext">
            <a class="boxnLinks" href="DigiReward.html">Digi Rewards</a>
          </td>
          <td class="boxntext">
            <a class="boxnLinks" href="help.html">Help </a>
          </td>
        </tr>
      </table>
    </div>`;
...
function footer() {
  return `
     ...
     <div id="bodybox82">
         ...
         <div id="bodybox822">
             <p>Copyright © KindMeal.my, 2014 - 2021. All rights reserved.</p>
